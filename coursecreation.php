            ...
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    <ul>
                        ...
                        <li><a href="createCourseCreation.php">Create</a></li>
                        <li><a href="viewCourseCreation.php">View</a></li>
                        <li><a href="editviewCourseCreation.php">Update</a></li>
                        <li><a href="deleteviewCourseCreation.php">Delete</a></li>
                    </ul>
                </div>
