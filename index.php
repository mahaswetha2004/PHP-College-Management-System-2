...
<section class="course">
    ...
    <div class="row">
        <div class="course-col">
            <h3>Objectives</h3>
            <p>Describe the ethical framework for how the College’s ethical review process will work.
            ...
            <p>Undergraduate education is education conducted after secondary education and before postgraduate education, 
                usually in a college or university. It typically includes all postsecondary programs up to the level of
                 a bachelor's degree.</p>
                 </div>
                 <div class="course-col">
            <h3>Post Graduate</h3>
            <p>The best postgraduate courses to pursue after an undergraduate degree are Master of Business Administration (MBA),
                 Master of Arts (MA), Master Of Science (MSc), Postgraduate Diploma (PGD),
                 Master of Technology (M. Tech), PhD, Master of Commerce, and a few other relative courses.</p>
        </div>
    </div>
</section>
    ...
    <p>Explore our beautiful campus that enables the right atmosphere
        ...
        <div class="row">
            <div class="facilities-col">
                ...
                <p>The Central Library is the indispensable hub of discovery, learning and creativity at DEI by providing
                     a distinguished collection of information resources </p>
            </div>
            <div class="facilities-col">
                <img src="images/basketball.png">
                <h3>Largest Play Ground</h3>
                <p>The World's largest basketball stadium is in the  college basketball stadiums are the biggest in the </p>
            </div>
            <div class="facilities-col">
                <img src="images/cafeteria.png">
                <h3>Tasty and Healthy Food</h3>
                <p>“Keep good food in your fridge to only eat good food.” “Heavier breakfast, lighter dinner.” 
                    “Healthy food, happy gut.” </p>
            </div>
        </div>
...
<p>Explore our beautiful campus that enables the right atmosphere
    ...
    <div class="row">
        <div class="testimonials-col">
            ...
            <div>
                <p>My college days are the best part of my life. My department encouraged me to explore my talent
                     & potential by providing an exceptional integrated learning environment.
                     I am really grateful to my teachers who have changed my whole aspect towards learning.
                </p>
                <h3>Christine Bery</h3>
