            ...
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    <ul>
                        ...
                        <li><a href="createStudentProfile.php">Create</a></li>
                        <li><a href="viewStudentProfile.php">View</a></li>
                        <li><a href="editviewStudentProfile.php">Update</a></li>
                        <li><a href="deleteviewStudentProfile.php">Delete</a></li>
                    </ul>
                </div>
