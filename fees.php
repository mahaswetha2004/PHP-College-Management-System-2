            ...
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    <ul>
                        ...
                        <li><a href="createFeesManagement.php">Create</a></li>
                        <li><a href="viewFeesManagement.php">View</a></li>
                        <li><a href="editviewFeesManagement.php">Update</a></li>
                        <li><a href="deleteviewFeesManagement.php">Delete</a></li>
                    </ul>
                </div>
