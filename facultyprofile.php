            ...
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    <ul>
                        ...
                        <li><a href="createFacultyProfile.php">Create</a></li>
                        <li><a href="viewFacultyProfile.php">View</a></li>
                        <li><a href="editviewFacultyProfile.php">Update</a></li>
                        <li><a href="deleteviewFacultyProfile.php">Delete</a></li>
                    </ul>
                </div>
