            ...
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    <ul>
                        ...
                        <li><a href="createGrade.php">Create</a></li>
                        <li><a href="viewGrade.php">View</a></li>
                        <li><a href="editviewGrade.php">Update</a></li>
                        <li><a href="deleteviewGrade.php">Delete</a></li>
                    </ul>
                </div>
