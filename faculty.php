            ...
            <nav>
                ...
                <div class="nav-links" id="navLinks">
                    <ul>
                        ...
                        <li><a href="createFacultyDetails.php">Create</a></li>
                        <li><a href="viewFacultyDetails.php">View</a></li>
                        <li><a href="editviewFacultyDetails.php">Update</a></li>
                        <li><a href="deleteviewFacultyDetails.php">Delete</a></li>
                    </ul>
                </div>
